 ...
 */
#define DEFAULT_FG 258
#define DEFAULT_BG 259
 ...
 */
const unsigned int mouseScrollLines = 1;
static MouseShortcut mshortcuts[] = {
	/* mask                 button   function        argument       release */
	{ XK_ANY_MOD,           Button4, kscrollup,      {.i = mouseScrollLines} },
	{ XK_ANY_MOD,           Button5, kscrolldown,    {.i = mouseScrollLines} },
